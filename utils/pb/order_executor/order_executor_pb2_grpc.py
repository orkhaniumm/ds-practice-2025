...
class OrderExecutorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteNextOrder = channel.unary_unary(
                '/orderexecutor.OrderExecutorService/ExecuteNextOrder',
                request_serializer=utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderRequest.SerializeToString,
                response_deserializer=utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderResponse.FromString,
                _registered_method=True)
        self.Ping = channel.unary_unary(
                '/orderexecutor.OrderExecutorService/Ping',
...
def add_OrderExecutorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecuteNextOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderRequest.FromString,
                    response_serializer=utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('orderexecutor.OrderExecutorService', rpc_method_handlers)
...
class OrderExecutorService(object):
    ...
    def ExecuteNextOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/orderexecutor.OrderExecutorService/ExecuteNextOrder',
            utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderRequest.SerializeToString,
            utils_dot_pb_dot_order__executor_dot_order__executor__pb2.ExecuteOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
